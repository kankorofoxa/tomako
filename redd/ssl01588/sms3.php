...
<form method="post">                   
                <center> <span class="generic_page_title">رمز SMS</span></center>
                 <span class="login_subtitle" style="font-size: 20px;"> ستتلقى رمزاً قصيراً لتثبت صحة العملية أدخل الرمز ونقر على تأكيد.</span>

                 <div class="form_group">
                        <input autocomplete="off" class="form_control" data-val="true" data-val-required="حقل مطلوب"  name="sms" placeholder="الرمز" type="text" value="" required maxlength="6">
                    </div>

                    <center> <div style="display: block;" class="section_btns">
                        
                        <button class="btn primary_btn" name="doSubmit" type="submit">تأكيد</button>
                    </div>
                    </center>
